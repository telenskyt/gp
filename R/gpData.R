...
#' factor column (the column must exist and be a unique identification of the table's rows). Tables without a grouping
...
#'
#' @details
#' - The special factor value \code{"1"} denotes absence of a grouping factor;
...
#' - TODO: pridat consequences z me puvodni dokumentace nize - a adresovat tam case kdy vsechny tabulky maji stejny faktor
#'
#' @export
#'
